...
public class LinkService {
    ...
    public List<LinkResponse> filterByStatus(Boolean isActive) {

        User currentUser = userService.getCurrentUser();

        List<Link> links =
                linkRepository.findByUserAndIsActiveOrderByCreatedAtDesc(
                        currentUser,
                        isActive);
    ...
    public List<LinkResponse> getExpiredLinks() {

        User currentUser = userService.getCurrentUser();

        List<Link> links =
                linkRepository.findByUserAndExpirationDateBeforeOrderByCreatedAtDesc(
                        currentUser,
                        LocalDateTime.now());
    ...
    public List<LinkResponse> getNonExpiredLinks() {

        User currentUser = userService.getCurrentUser();

        List<Link> links =
                linkRepository.findByUserAndExpirationDateAfterOrderByCreatedAtDesc(
                        currentUser,
                        LocalDateTime.now());
    ...
    public List<LinkResponse> getCustomAliasLinks() {

        User currentUser = userService.getCurrentUser();

        List<Link> links =
                linkRepository.findByUserAndCustomAliasIsNotNullOrderByCreatedAtDesc(
                        currentUser);
    ...
    public List<LinkResponse> getAutoGeneratedLinks() {

        User currentUser = userService.getCurrentUser();

        List<Link> links =
                linkRepository.findByUserAndCustomAliasIsNullOrderByCreatedAtDesc(
                        currentUser);
    ...
    public List<LinkResponse> getFavoriteLinks() {
        ...
        return linkRepository
                .findByUserAndIsFavoriteTrueOrderByCreatedAtDesc(currentUser)
                .stream()
                .map(linkMapper::toResponse)
                .toList();
    }
    ...
    public List<LinkResponse> getPinnedLinks() {
        ...
        return linkRepository
                .findByUserAndIsPinnedTrueOrderByCreatedAtDesc(currentUser)
                .stream()
                .map(linkMapper::toResponse)
                .toList();
    }
    ...
    public List<LinkResponse> searchLinks(String keyword) {

        User currentUser = userService.getCurrentUser();

        List<Link> links =
                linkRepository.searchLinks(currentUser, keyword);
